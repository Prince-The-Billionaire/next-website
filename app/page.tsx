    ...
    <main className="w-screen h-screen relative">
      <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage: "url(/main-bg.webp)"}}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <div className="gap-5 flex-col md:flex-row hidden md:flex">
            <Link href="/my-skills" className="rounded-[20px] relative group bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]">
              Learn more
            </Link>
            <Link href="/my-projects" className="rounded-[20px] relative group bg-transparent border border-white px-5 py-3 text-lg text-white max-w-[200px]">
      ...
      <div className="flex gap-5 absolute bottom-10 z-[20] right-5 flex-col hidden">
